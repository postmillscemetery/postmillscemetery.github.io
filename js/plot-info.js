...
function plotInfo(){
    ...
    function buildPopupHtml(p){
        ...
        if (editDate) html += '<tr><td colspan="2" style="font-weight:normal; font-style: italic;text-align: right; border-bottom:none;">Last Edit: ' +  editDate.toLocaleDateString('en-US') + '</td></tr>';
